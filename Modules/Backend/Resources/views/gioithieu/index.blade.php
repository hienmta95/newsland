...
<div class="sp-push-index">
    ...
    <div class="grid-view" id="w0">
        <div class="summary">
            <table class="table table-striped table-bordered table-style" id="gioithieu-table">
                <thead>
                    <tr>
                        <th class="un-orderable-col">#</th>
                        <th class="orderable-col">ID</th>
                        <th class="un-orderable-col">Tiêu đề bài giới thiệu </th>
...
@push('scripts')
<script>
    var table = $('#gioithieu-table').DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        autoWidth: true,
        ...
        ajax: '{!! route('backend.gioithieu.indexData') !!}',
        ...
        "initComplete": function () {
            $('#gioithieu-table_paginate').css({"float": "left"});
            var r = $('#gioithieu-table tfoot tr');
            $('#gioithieu-table thead').append(r);
            this.api().columns().every(function (i) {
                if (i != 0 && i != 7 && i != 6 && i != 1) {
                    ...
                    $('#gioithieu-table thead tr th input').css({"width": "100%", "margin": "0px 0px 0px 0px"});
                }
            });
